...
function searchShow(show, season, episode) {
    ...
    return request({
        uri:     config.addic7ed_url + '/srch.php',
        qs:      {
...
function findSubtitles (body) {
    var subs          = [],
        ...
        // titleMatch    = body.match(/(.+?) - \d\dx\d\d - (.+?) <small/),    //for shows
        // titleMatch    = body.match(/(?<=content=")(.*)(?= subtitles. )/),    //for movies
        // titleMatch    = "Joker (2019)",
